...
type WorkerRegistration struct {
	...
	RecentDirectories  []string               `protobuf:"bytes,7,rep,name=recent_directories,json=recentDirectories,proto3" json:"recent_directories,omitempty"` // Directories of recently processed files
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *WorkerRegistration) GetRecentDirectories() []string {
	if x != nil {
		return x.RecentDirectories
	}
	return nil
}
...
type BatchCompileJobRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Jobs          []*CompileJobRequest   `protobuf:"bytes,1,rep,name=jobs,proto3" json:"jobs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchCompileJobRequest) Reset() {
	*x = BatchCompileJobRequest{}
	mi := &file_internal_proto_builder_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchCompileJobRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchCompileJobRequest) ProtoMessage() {}

func (x *BatchCompileJobRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_builder_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchCompileJobRequest.ProtoReflect.Descriptor instead.
func (*BatchCompileJobRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_builder_proto_rawDescGZIP(), []int{10}
}

func (x *BatchCompileJobRequest) GetJobs() []*CompileJobRequest {
	if x != nil {
		return x.Jobs
	}
	return nil
...
type BatchCompileJobResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Responses     []*CompileJobResponse  `protobuf:"bytes,1,rep,name=responses,proto3" json:"responses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchCompileJobResponse) Reset() {
	*x = BatchCompileJobResponse{}
	mi := &file_internal_proto_builder_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchCompileJobResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchCompileJobResponse) ProtoMessage() {}

func (x *BatchCompileJobResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_builder_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchCompileJobResponse.ProtoReflect.Descriptor instead.
func (*BatchCompileJobResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_builder_proto_rawDescGZIP(), []int{11}
}

func (x *BatchCompileJobResponse) GetResponses() []*CompileJobResponse {
	if x != nil {
		return x.Responses
	}
	return nil
...
type BatchLinkJobRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Jobs          []*LinkJobRequest      `protobuf:"bytes,1,rep,name=jobs,proto3" json:"jobs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchLinkJobRequest) Reset() {
	*x = BatchLinkJobRequest{}
	mi := &file_internal_proto_builder_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchLinkJobRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchLinkJobRequest) ProtoMessage() {}

func (x *BatchLinkJobRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_builder_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchLinkJobRequest.ProtoReflect.Descriptor instead.
func (*BatchLinkJobRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_builder_proto_rawDescGZIP(), []int{12}
}

func (x *BatchLinkJobRequest) GetJobs() []*LinkJobRequest {
	if x != nil {
		return x.Jobs
	}
	return nil
...
type BatchLinkJobResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Responses     []*LinkJobResponse     `protobuf:"bytes,1,rep,name=responses,proto3" json:"responses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchLinkJobResponse) Reset() {
	*x = BatchLinkJobResponse{}
	mi := &file_internal_proto_builder_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchLinkJobResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchLinkJobResponse) ProtoMessage() {}

func (x *BatchLinkJobResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_builder_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchLinkJobResponse.ProtoReflect.Descriptor instead.
func (*BatchLinkJobResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_builder_proto_rawDescGZIP(), []int{13}
}

func (x *BatchLinkJobResponse) GetResponses() []*LinkJobResponse {
	if x != nil {
		return x.Responses
	}
	return nil
...
func (x *DirectoryUpdateRequest) Reset() {
	*x = DirectoryUpdateRequest{}
	mi := &file_internal_proto_builder_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DirectoryUpdateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DirectoryUpdateRequest) ProtoMessage() {}

func (x *DirectoryUpdateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_builder_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DirectoryUpdateRequest.ProtoReflect.Descriptor instead.
func (*DirectoryUpdateRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_builder_proto_rawDescGZIP(), []int{14}
}

func (x *DirectoryUpdateRequest) GetWorkerId() string {
	if x != nil {
		return x.WorkerId
	}
	return ""
...
func (x *DirectoryUpdateRequest) GetDirectories() []string {
	if x != nil {
...
func (x *DirectoryUpdateResponse) Reset() {
	*x = DirectoryUpdateResponse{}
	mi := &file_internal_proto_builder_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DirectoryUpdateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DirectoryUpdateResponse) ProtoMessage() {}

func (x *DirectoryUpdateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_builder_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DirectoryUpdateResponse.ProtoReflect.Descriptor instead.
func (*DirectoryUpdateResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_builder_proto_rawDescGZIP(), []int{15}
}

func (x *DirectoryUpdateResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_internal_proto_builder_proto_rawDesc = string([]byte{
	...
	0x08, 0x52, 0x08, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xa1, 0x02, 0x0a, 0x12, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72,
	...
	0x52, 0x08, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x4d, 0x62, 0x12, 0x2d, 0x0a, 0x12, 0x72, 0x65,
	0x63, 0x65, 0x6e, 0x74, 0x5f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73,
	0x18, 0x07, 0x20, 0x03, 0x28, 0x09, 0x52, 0x11, 0x72, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x44, 0x69,
	0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0xd0, 0x01, 0x0a, 0x0f, 0x4a, 0x6f,
	0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x15, 0x0a,
	...
	0x61, 0x67, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x5f, 0x69, 0x64,
	...
	0x6d, 0x65, 0x5f, 0x6d, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x65, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x4d, 0x73, 0x12, 0x1e, 0x0a, 0x0b,
	0x69, 0x73, 0x5f, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x6a, 0x6f, 0x62, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x09, 0x69, 0x73, 0x4c, 0x69, 0x6e, 0x6b, 0x4a, 0x6f, 0x62, 0x22, 0x2a, 0x0a, 0x0c,
	0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x41, 0x63, 0x6b, 0x12, 0x1a, 0x0a, 0x08,
	0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08,
	0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x22, 0x29, 0x0a, 0x10, 0x4a, 0x6f, 0x62, 0x53,
	...
	0x62, 0x49, 0x64, 0x22, 0xcc, 0x01, 0x0a, 0x11, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x49, 0x64, 0x12, 0x20, 0x0a,
	...
	,
...
var file_internal_proto_builder_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_internal_proto_builder_proto_goTypes = []any{
	...
	(*BatchCompileJobRequest)(nil),  // 10: builder.BatchCompileJobRequest
	(*BatchCompileJobResponse)(nil), // 11: builder.BatchCompileJobResponse
	(*BatchLinkJobRequest)(nil),     // 12: builder.BatchLinkJobRequest
	(*BatchLinkJobResponse)(nil),    // 13: builder.BatchLinkJobResponse
	(*DirectoryUpdateRequest)(nil),  // 14: builder.DirectoryUpdateRequest
	(*DirectoryUpdateResponse)(nil), // 15: builder.DirectoryUpdateResponse
}
var file_internal_proto_builder_proto_depIdxs = []int32{
	...
	1,  // 2: builder.BatchCompileJobRequest.jobs:type_name -> builder.CompileJobRequest
	3,  // 3: builder.BatchCompileJobResponse.responses:type_name -> builder.CompileJobResponse
	2,  // 4: builder.BatchLinkJobRequest.jobs:type_name -> builder.LinkJobRequest
	4,  // 5: builder.BatchLinkJobResponse.responses:type_name -> builder.LinkJobResponse
	1,  // 6: builder.BuildService.SubmitCompileJob:input_type -> builder.CompileJobRequest
	2,  // 7: builder.BuildService.SubmitLinkJob:input_type -> builder.LinkJobRequest
	5,  // 8: builder.BuildService.WorkerStream:input_type -> builder.WorkerRegistration
	6,  // 9: builder.BuildService.ReportJobStatus:input_type -> builder.JobStatusReport
	8,  // 10: builder.BuildService.GetJobStatus:input_type -> builder.JobStatusRequest
	10, // 11: builder.BuildService.SubmitBatchCompileJobs:input_type -> builder.BatchCompileJobRequest
	12, // 12: builder.BuildService.SubmitBatchLinkJobs:input_type -> builder.BatchLinkJobRequest
	14, // 13: builder.BuildService.UpdateDirectories:input_type -> builder.DirectoryUpdateRequest
	3,  // 14: builder.BuildService.SubmitCompileJob:output_type -> builder.CompileJobResponse
	4,  // 15: builder.BuildService.SubmitLinkJob:output_type -> builder.LinkJobResponse
	0,  // 16: builder.BuildService.WorkerStream:output_type -> builder.JobRequest
	7,  // 17: builder.BuildService.ReportJobStatus:output_type -> builder.JobStatusAck
	9,  // 18: builder.BuildService.GetJobStatus:output_type -> builder.JobStatusResponse
	11, // 19: builder.BuildService.SubmitBatchCompileJobs:output_type -> builder.BatchCompileJobResponse
	13, // 20: builder.BuildService.SubmitBatchLinkJobs:output_type -> builder.BatchLinkJobResponse
	15, // 21: builder.BuildService.UpdateDirectories:output_type -> builder.DirectoryUpdateResponse
